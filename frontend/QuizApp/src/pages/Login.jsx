...
const Login = () => {
  ...
  return (
    <div className="min-h-screen flex items-center justify-center bg-gradient-to-br from-purple-50 to-indigo-50 dark:from-gray-900 dark:to-purple-900 p-4">
      ...
      <div className="w-full max-w-4xl flex overflow-hidden rounded-3xl shadow-xl">
        {/* Image Section */}
        <motion.div 
          initial={{ x: -50, opacity: 0 }}
          animate={{ x: 0, opacity: 1 }}
          transition={{ duration: 0.5 }}
          className="hidden md:block w-1/2 bg-black rounded-l-3xl overflow-hidden relative"
        >
